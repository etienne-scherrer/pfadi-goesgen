...
Ext.define("am.store.TextTypeCodeTypeStore", {
    ...
    statics: {
        ...
        isEventTextType: function (a) {
            return a == this.ANSCHLAG_WOLFE_ID || a == this.ANSCHLAG_PFADER_ID || a == this.ANSCHLAG_BIBER_ID
        },
        hasAdditionalText: function (a) {
            return a == this.ANSCHLAG_WOLFE_ID || a == this.ANSCHLAG_PFADER_ID || a == this.ANSCHLAG_BIBER_ID
        },
        additionalTextNaming: function (a) {
            if (a == this.ANSCHLAG_WOLFE_ID || a == this.ANSCHLAG_PFADER_ID || a == this.ANSCHLAG_BIBER_ID) {
                return "Mitnehmen"
            }
            return "Zusatz Text"
        },
...
Ext.define("am.view.NavigationPanel", {
    ...
    dockedItems: [{
        ...
        items: [Ext.create("Ext.Component", {
            x: 0,
            y: 0,
            html: '<a href="index.php"><img src="resources/apollomin.jpg" alt="ApolloGraphic" /></a>'
        })]
    }],
    initComponent: function () {
